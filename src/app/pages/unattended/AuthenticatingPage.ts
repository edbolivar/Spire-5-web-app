...
export default class AuthenticatingPage extends AbstractScreen {  

  static _instance: AuthenticatingPage;
  ...
  constructor(appInfo: AppInfoService) {
    ...
    SubscribeEvent.Create(PubSubTopic.idleStateChanged, this.objectId)
      ...
      .Done();
      AuthenticatingPage._instance = this;
  }
  ...
  public destroy() {
    ...
    this._videos = [];
    this._cover.destroy();
    AuthenticatingPage._instance = null;
    super.destroy();
  }
