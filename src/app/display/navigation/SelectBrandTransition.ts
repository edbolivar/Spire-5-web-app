...
import { PlatformModel, PourableDesign } from '../../universal/app.types';
...
export class SelectBrandTransition implements Transition {
  ...
  constructor(platform: PlatformModel, beverage: PourableDesign, rotationSpeed: number, startRotation: number, startPosition: Point, startRadius: number) {
