...
export type AnimatedSpriteControllerArgs = (sprite: AnimatedSpriteController) => void;

export default class AnimatedSpriteController {
  public onFinishedPlaying = new SimpleSignal<AnimatedSpriteControllerArgs>();
  ...
  private _animationDefinition: DesignAnimation;
  private _onLoaded = new SimpleSignal<AnimatedSpriteControllerArgs>();

  constructor(
    animationDefinition: DesignAnimation
  ) {
  ...
  public unset() {
    ...
    this.onFinishedPlaying.removeAll();
  }
